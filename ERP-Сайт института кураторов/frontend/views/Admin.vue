    ...
    methods: {
       ...
       add_quest(){
         if(this.$refs.quest_form.validate()){
           ...
           const data = t
           axios.post('http://127.0.0.1:5000/endorfin/1/quests/', data).then((resp) => {
       ...
       achieve_quest(){
         ...
         axios.put('http://127.0.0.1:5000/endorfin/1/admin/achieve_quest', data).then((resp) => {
         })
       }
     },
    created(){
      axios.get('http://127.0.0.1:5000/endorfin/1/admin/').then((resp) => {
